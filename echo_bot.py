...
admins = {
    'warn': [@WaB3pMa, @Doshik_1_8_5, @Alishka_admin],  # Список ID пользователей, которые могут использовать команду /warn
    'mute': [@WaB3pMa, @Doshik_1_8_5, @Alishka_admin],  # Список ID пользователей, которые могут использовать команду /mute
    'ban': [@Alishka_admin],   # Список ID пользователей, которые могут использовать команду /ban
    'unmute': [@WaB3pMa, @Doshik_1_8_5, @Alishka_admin] # Список ID пользователей, которые могут использовать команду /unmute
}
